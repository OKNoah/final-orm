...
var ALIASES, Exp, KEYWORDS, ParseError, PathAccessor, PathStructure, PipeStructure, Structure, Token, TokenList, VAR_CONTEXT, VAR_HELPERS, VAR_LOCALS, VAR_REF, VAR_VALUE, createExp, createGetter, createSetter, createStringExp,
  slice = [].slice,
...
createGetter = function(code) {
  ...
  return function(context, locals) {
    return getter(context, locals, Exp);
  };
};
...
createSetter = function(code) {
  ...
  try {
    ...
    return function(context, value, locals) {
      return setter(context, value, locals, Exp);
    };
  } catch (error) {
    return null;
  }
